...
.nav-form {
    -fx-background-color: linear-gradient(to bottom right, #021b79, #0575e6);
}
...
.nav-btn-selected {
    -fx-background-color: rgba(255, 255, 255, 0.2); /* Color de fondo para el botón seleccionado */
    -fx-text-fill: #fff; /* Cambiar el color del texto si es necesario */
    -fx-border-color: #fff; /* Agrega un borde blanco si deseas resaltar más */
    -fx-border-width: 1px; /* Ancho del borde */
